    ...
    <div className="site">
      ...
      >
        ...
        <div className="container hero-inner">
          <p className="tag reveal">Elegance in Every Detail</p>
          ...
          <div className="featured-grid">
            ...
            <article className="featured-card reverse reveal">
              ...
              <div className="featured-text">
                ...
                <p>
                  Step into a dreamy celebration under the open sky — where elegance meets nature.
      From flowing floral arrangements to ambient lighting, every detail is curated
      to make your outdoor wedding a timeless memory.
                </p>
              </div>
            </article>
...
<section id="mosaic" className="mosaic-section reveal">
  ...
  >
    <SwiperSlide>
      <img src="/images/482144189_2217595118638176_324840492972745833_n.jpg" alt="Detail 1" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="/images/483214749_1362534561749446_1251849253510767112_n.jpg" alt="Detail 2" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="/images/491433554_18122392489444378_7097424086896697170_n.jpg" alt="Detail 3" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="/images/504598637_1503293024382939_8505140994921066569_n.jpg" alt="Detail 4" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="/images/528316404_1411610776739217_4068103587940238655_n.jpg" alt="Detail 5" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="/images/521293297_18130697710444378_2951060685034046885_n.jpg" alt="Detail 6" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="/images/513928101_18128884513444378_7438463624269673816_n.jpg" alt="Detail 7" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="/images/508794641_1046252324240596_2362747253516824541_n.jpg" alt="Detail 8" />
    </SwiperSlide>
  </Swiper>
</section>
      ...
      <section id="about" className="section section-alt">
        <div className="container about-grid">
          <div className="about-text reveal">
            <h2>About Us</h2>
            <p>
              We’re artisans of atmosphere. From intimate gatherings to grand celebrations,
              we design spaces that feel personal, polished, and unforgettable.
            </p>
          ...
          <div className="about-media reveal">
            <img src="/images/Dream Decors Events Logo_page-0001.jpg" alt="Dream Decors team at work" />
          </div>
        </div>
      </section>

      {/* ====== Process (adds length + clarity) ====== */}
      <section id="process" className="section">
        <div className="container">
          ...
          <ol className="steps">
            <li className="reveal"><span className="step-num">1</span><div><h4>Discover</h4><p>We listen to your story, venue, and vision.</p></div></li>
            <li className="reveal"><span className="step-num">2</span><div><h4>Design</h4><p>Moodboards, palettes, and layouts tailored to you.</p></div></li>
            <li className="reveal"><span className="step-num">3</span><div><h4>Deliver</h4><p>On-site execution with meticulous detailing.</p></div></li>
          </ol>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="testi-grid">
            <blockquote className="testi reveal">
              “Every corner felt intentional. Dream Decors brought our story to life.”
              <cite>— Aisha & Karan</cite>
            </blockquote>
            <blockquote className="testi reveal">
              “Professional, calm, and exceptionally creative. Our launch looked world-class.”
        ...
        <div className="container">
          ...
          <div className="faq-grid">
            ...
            <div className="faq-item reveal">
              ...
              <p>For weddings, 2–4 months in advance is ideal; for brand events, 3–6 weeks.</p>
            </div>
            <div className="faq-item reveal">
              <h4>What’s the typical budget?</h4>
              <p>Packages are tailored. We’ll shape a design that fits your priorities.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container contact-grid">
          <div className="contact-text reveal">
            ...
            <ul className="contact-list">
              ...
              <li><strong>Email:</strong> hello@dreamdecors.in</li>
          ...
          <form className="contact-form reveal" onSubmit={(e) => e.preventDefault()}>
            ...
            <label>Email<input type="email" required placeholder="you@mail.com" /></label>
            <label>Event Details<textarea rows="5" placeholder="Date, venue, guest count" /></label>
